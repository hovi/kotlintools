...
class StringUtilTest {
    ...
    fun removeCzechAccents() {
        ...
        assertEquals("prilis zlutoucky kun upel dabelske odyprilis zlutoucky kun upel dabelske ody", "příliš žluťoučký kůň úpěl ďábelské ódypříliš žluťoučký kůň úpěl ďábelské ódy".removeAccents())
    }
